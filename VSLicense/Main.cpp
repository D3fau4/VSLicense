...
int main(int argc, char** argv)
{
	try
	{
		cxxopts::Options options("VSLicenseCpp", "Get and set Visual Studio license expiration date.");
		...
		{
			wprintf(L"Version not supported!\nAvailable versions: VS2015, VS2017, VS2019, VS2022\nExample: VSLicenseCpp.exe --version=VS2022 --get");
		}
	}
